...
public class RestWithSpringbootController {
    ...
    public String getBpost() {
        ...
        res = restTemplate.exchange(next_hop, HttpMethod.POST, HttpEntity.EMPTY, String.class);
    ...
    public String getBdelete() {
        ...
        ResponseEntity<String> res;
        res = restTemplate.exchange(next_hop, HttpMethod.DELETE, HttpEntity.EMPTY, String.class);
        if (res.getStatusCodeValue() != 200) {
            throw new RuntimeException(res.getStatusCode().getReasonPhrase());
        }
        return res.getBody();
    ...
    public String getBhead() {
        ...
        ResponseEntity<String> res;
        res = restTemplate.exchange(next_hop, HttpMethod.HEAD, HttpEntity.EMPTY, String.class);
        if (res.getStatusCodeValue() != 200) {
            throw new RuntimeException(res.getStatusCode().getReasonPhrase());
        }
        return res.getBody();
    ...
    public String getBoptions() {
        ...
        ResponseEntity<String> res;
        res = restTemplate.exchange(next_hop, HttpMethod.OPTIONS, HttpEntity.EMPTY, String.class);
        if (res.getStatusCodeValue() != 200) {
            throw new RuntimeException(res.getStatusCode().getReasonPhrase());
        }
        return res.getBody();
    ...
    public String getBput() {
        ...
        ResponseEntity<String> res;
        res = restTemplate.exchange(next_hop, HttpMethod.PUT, HttpEntity.EMPTY, String.class);
        if (res.getStatusCodeValue() != 200) {
            throw new RuntimeException(res.getStatusCode().getReasonPhrase());
        }
        return res.getBody();
    ...
    public String getBpatch() {
        ...
        ResponseEntity<String> res;
        res = restTemplate.exchange(next_hop, HttpMethod.PATCH, HttpEntity.EMPTY, String.class);
        if (res.getStatusCodeValue() != 200) {
            throw new RuntimeException(res.getStatusCode().getReasonPhrase());
        }
        return res.getBody();
    ...
    public String getBheadertest() {
        ...
        ResponseEntity<String> res;
        res = restTemplate.exchange(next_hop, HttpMethod.GET, request, String.class);
        if (res.getStatusCodeValue() != 200) {
            throw new RuntimeException(res.getStatusCode().getReasonPhrase());
        }
        return res.getBody();
    ...
    public String getBrequestparamtest() {
        ...
        ResponseEntity<String> res;
        res = restTemplate.exchange(urlTemplate, HttpMethod.GET, HttpEntity.EMPTY, String.class);
        if (res.getStatusCodeValue() != 200) {
            throw new RuntimeException(res.getStatusCode().getReasonPhrase());
        }
        return res.getBody();
    ...
    public String getBpathvariabletest() {
        ...
        ResponseEntity<String> res;
        res = restTemplate.exchange(next_hop, HttpMethod.GET, HttpEntity.EMPTY, String.class);
        if (res.getStatusCodeValue() != 200) {
            throw new RuntimeException(res.getStatusCode().getReasonPhrase());
        }
        return res.getBody();
    ...
    public String getBbodytest() {
        ...
        ResponseEntity<String> res;
        res = restTemplate.exchange(next_hop, HttpMethod.POST, request, String.class);
        if (res.getStatusCodeValue() != 200) {
            throw new RuntimeException(res.getStatusCode().getReasonPhrase());
        }
        return res.getBody();
    ...
    public User getBUser() {
        ...
        res = restTemplate.exchange(next_hop, HttpMethod.POST, request, User.class);
        if (res.getStatusCodeValue() != 200) {
            throw new RuntimeException(res.getStatusCode().getReasonPhrase());
        }
        return res.getBody();
