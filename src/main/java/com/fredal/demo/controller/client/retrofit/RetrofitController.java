...
public class RetrofitController {
    ...
    @PostConstruct
    public void init() {
        retrofitb = new Retrofit.Builder().baseUrl(urlb).addConverterFactory(ScalarsConverterFactory.create()).build();
        retrofitb1 = new Retrofit.Builder().baseUrl(urlb).addConverterFactory(GsonConverterFactory.create()).build();
        retrofitgetb1 = new Retrofit.Builder().baseUrl(urlb1).addConverterFactory(ScalarsConverterFactory.create()).build();
        retrofitgetb2 = new Retrofit.Builder().baseUrl(urlb2).addConverterFactory(ScalarsConverterFactory.create()).build();
        retrofitp = new Retrofit.Builder().baseUrl(urlp).addConverterFactory(ScalarsConverterFactory.create()).build();
    ...
    public String passthrough() throws IOException {
        Call<String> call =   clientp.passthrough();
